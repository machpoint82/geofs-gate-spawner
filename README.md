...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-2.1.0-06b6d4" alt="Version 2.1.0" />
...
**Right now this only covers EGLL (London Heathrow).** More airports will be added over time — check back on this repo for updates, and the script will auto-update itself once new airports are added to `gates.json`.
